    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-600 max-w-xs mx-auto">
          Don't worry, it happens. Enter your email linked to your patient account.
        </p>
      </div>
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    type="email"
                    required
                    className="focus:ring-patient focus:border-patient block w-full pl-10 sm:text-sm border-slate-300 rounded-lg p-3 border"
